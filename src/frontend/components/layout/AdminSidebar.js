...
import {
  ...
  Wallet, Star, LogOut, ChevronRight,
  PanelLeftClose, PanelLeftOpen, Mountain, Settings, X,
} from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="h-16 px-3 flex items-center border-b border-green-100 dark:border-dark-border shrink-0">
        {!collapsed && (
          <Link href="/admin/dashboard" className="flex items-center gap-3 flex-1 min-w-0 no-underline hover:opacity-80 transition-opacity">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-gray-400 dark:text-gray-500">Admin Portal</p>
            </div>
          </Link>
        )}
